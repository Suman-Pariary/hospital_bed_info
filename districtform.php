    ...
    <section id="contact" class="contact">
      ...
      <div class="container" align="center">
        ...
        <div class="row mt-5">
            ...
            <input type="hidden" name="action" value="districtinsert">
              <div class="row">
				  <div class="col form-group">
					  <select name="state-id" id="state-id" class="form-control" required>
						  <option value="">--State--</option>
						  <?php
						  $qrylogdata = mysqli_query($link, "Select * from state_table where state_status='Active'");
						  while($rowsqldata = mysqli_fetch_assoc($qrylogdata)){ 
						  ?>
						  <option value="<?php echo $rowsqldata['state_id'];?>"><?php echo $rowsqldata['state_name'];?></option>
						  <?php } ?>
					  </select>
                  
                </div>
                <div class="col form-group">
                  <input type="text" name="district_name" class="form-control" id="district_name" placeholder="District Name" required>
                </div>
                <div class="col form-group">
