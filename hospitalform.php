    ...
    <section id="contact" class="contact">
      ...
      <div class="container" align="center">
        ...
        <div class="row mt-5">
            ...
            <input type="hidden" name="action" value="hospitalinsert">
              <div class="row">
              <div class="col form-group">
					  <select name="dist_id" id="dist_id" class="form-control" required>
						  <option value="">--District--</option>
						  <?php
						  $qrylogdata = mysqli_query($link, "Select * from district_table dt, state_table st where dt.state_id = st.state_id and st.state_status='Active'");
						  while($rowsqldata = mysqli_fetch_assoc($qrylogdata)){ 
						  ?>
						  <option value="<?php echo $rowsqldata['dist_id'];?>"><?php echo $rowsqldata['state_name']."-".$rowsqldata['dist_name'];?></option>
						  <?php } ?>
					  </select>
                ...
                <div class="row">
				  <div class="col form-group">
                  <input type="number" name="contact_no" class="form-control" id="contact_no" placeholder="Contact No" required>
                </div>
                </div>
                  <div class="row">&nbsp;</div>
                <div class="row">
