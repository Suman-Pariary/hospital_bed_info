...
$qrylogdata = mysqli_query($link, "Select * from bed_table where info_id =".$_GET['id']);
    ...
    <section id="contact" class="contact">
      ...
      <div class="container" align="center">
        ...
        <div class="row mt-5">
            ...
            <input type="hidden" name="action" value="bededit"
              <div class="row">
              <div class="col form-group">
					  <select name="hospital_id" id="hospital_id" class="form-control" required>
						  ...
						  ?>
						  <option value="<?php echo $rowsqldata1['hospital_id'];?>"  <?php if($rowsqldata['hospital_id'] == $rowsqldata1['hospital_id']) echo 'selected';?>><?php echo $rowsqldata1['hospital_name'];?></option>
						  <?php } ?>
					  </select>
                ...
                <div class="col form-group">
					  <select name="bed_type" id="bed_type" class="form-control" required>
						  ...
						  ?>
						  <option value="<?php echo $rowsqldata2['bed_id'];?>" <?php if($rowsqldata['bed_type'] == $rowsqldata2['bed_id']) echo 'selected';?>><?php echo $rowsqldata2['bed_type'];?></option>
						  <?php } ?>
					  </select>
                ...
                <div class="row">&nbsp;</div>
                 <div class="row">
                <div class="col form-group">
                  <input type="number" name="total_bed" class="form-control" id="total_bed" placeholder="Total Bed" required value="<?php echo  $rowsqldata['total_bed'];?>">
                </div>
                </div>
                <div class="row">&nbsp;</div>
                 <div class="row">
                <div class="col form-group">
                  <input type="number" name="available_bed" class="form-control" id="available_bed" placeholder="Available Bed" required value="<?php echo  $rowsqldata['available_bed'];?>">
                </div>
